...
function getErrorComponent(code, cause) {
  return (0, import_variant8.match)(code, {
    ...
    TranslationUnsupportedForProjectType: () => {
      return () => /* @__PURE__ */ import_react9.default.createElement(ErrorMessage, { message: "Translation pull command only applicable for headless sites." });
    },
    FailedToRenewAuthToken: () => {
...
//# sourceMappingURL=chunk-3Q7XZST5.js.map